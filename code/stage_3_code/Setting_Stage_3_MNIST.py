...
class Setting_Stage_3_MNIST(setting):
    def __init__(self, sName='Stage 3 MNIST Setting', sDescription=None):
    ...
    def load_run_save_evaluate(self):
        ...
        train_dataset = Dataset_MNIST(train_data)
        test_dataset = Dataset_MNIST(test_data)
