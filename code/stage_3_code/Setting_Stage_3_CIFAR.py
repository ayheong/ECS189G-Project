...
from Dataset_CIFAR import Dataset_CIFAR

class Setting_Stage_3_CIFAR(setting):
    def __init__(self, sName='Stage 3 CIFAR Setting', sDescription=None):
    ...
    def load_run_save_evaluate(self):
        ...
        train_dataset = Dataset_CIFAR(train_data)
        test_dataset = Dataset_CIFAR(test_data)
